...
const styles = StyleSheet.create({
  ...
  heading: { color: 'rgba(255,255,255,0.7)', ...TypeScale.body, fontWeight: '700', textTransform: 'uppercase', letterSpacing: 1, marginBottom: Spacing.sm },
  totalLabel: { color: 'rgba(255,255,255,0.7)', ...TypeScale.bodyLg },
  totalAmount: { color: Colors.white, ...TypeScale.display, fontWeight: '800', marginTop: 4 },
  totalCount: { color: 'rgba(255,255,255,0.6)', ...TypeScale.body, marginTop: 4 },
  ...
  rowInfo: { flex: 1 },
  rowTitle: { ...TypeScale.bodyLg, fontWeight: '600', color: Colors.textPrimary },
  rowDate: { ...TypeScale.caption, color: Colors.textMuted, marginTop: 3 },
  rowAmount: { ...TypeScale.title, fontWeight: '800', color: Colors.liferPrimary },
