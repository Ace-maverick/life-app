...
const styles = StyleSheet.create({
  ...
  count: { ...TypeScale.body, color: Colors.textMuted, fontWeight: '500' },
  ...
  filterText: { ...TypeScale.body, fontWeight: '600', color: Colors.textMuted },
  ...
  info: { flex: 1 },
  title: { ...TypeScale.bodyLg, fontWeight: '600', color: Colors.textPrimary },
  meta: { ...TypeScale.caption, color: Colors.textMuted, marginTop: 3 },
  right: { alignItems: 'flex-end', gap: 5 },
  price: { ...TypeScale.body, fontWeight: '700', color: Colors.posterPrimary },
